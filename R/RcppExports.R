...
pNorm1D <- function(x, mean, sd) {
    .Call('_hmdpPricePigIT_pNorm1D', PACKAGE = 'hmdpPricePigIT', x, mean, sd)
}
...
pNorm2D_arma <- function(lower, upper, mean, sigma) {
    .Call('_hmdpPricePigIT_pNorm2D_arma', PACKAGE = 'hmdpPricePigIT', lower, upper, mean, sigma)
}
...
pNorm2D <- function(lower, upper, mean, sigma) {
    .Call('_hmdpPricePigIT_pNorm2D', PACKAGE = 'hmdpPricePigIT', lower, upper, mean, sigma)
}
...
BuildHMDP2 <- function(filePrefix, param, paramDLMP, paramDLMPi, paramDLMF, paramPolicy) {
    .Call('_hmdpPricePigIT_BuildHMDP2', PACKAGE = 'hmdpPricePigIT', filePrefix, param, paramDLMP, paramDLMPi, paramDLMF, paramPolicy)
}
...
BuildHMDP2Deterministic <- function(filePrefix, param, paramDLMP, paramDLMPi, paramDLMF, paramPolicy) {
    .Call('_hmdpPricePigIT_BuildHMDP2Deterministic', PACKAGE = 'hmdpPricePigIT', filePrefix, param, paramDLMP, paramDLMPi, paramDLMF, paramPolicy)
}
...
SimulatePigs <- function(pigs, samples, weeks, prices, V, B, R) {
    .Call('_hmdpPricePigIT_SimulatePigs', PACKAGE = 'hmdpPricePigIT', pigs, samples, weeks, prices, V, B, R)
}
