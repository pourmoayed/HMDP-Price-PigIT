...
## 
## The model is per default soved with a more sparse discretization (see optimize_hmdp.R if you want
...
if (!useScenariosPaper){
  ...
  message("Use the scenarios and the optimal actions (scenarios_paper folder):")
